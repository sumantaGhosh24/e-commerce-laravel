...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.profile.edit')->with('message', 'Admin information updated successfully!');
    }
    ...
    public function address(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.profile.edit')->with('message', 'Admin address updated successfully!');
    }
    ...
    public function image(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.profile.edit')->with('message', 'Admin image updated successfully!');
    }
