            ...
            <div class="bg-white rounded-lg shadow-md p-8 shadow-black container mx-auto overflow-y-scroll">
                ...
                <table class="min-w-full bg-white rounded-lg shadow-md mx-auto mt-5">
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        ...
                        <td class="py-3 px-6 text-left">{{ $details['order']->id }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">User Name</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->user->firstName }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">User Email</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->user->email }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Address</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->address }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">City</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->city }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Pincode</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->pincode }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Total Price</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->total_price }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Net Price</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->net_price }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Order Status</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->order_status }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Coupon Value</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->coupon_value }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Coupon Code</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->coupon_code }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Payment</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->paymentResultId }} | {{ $details['order']->paymentResultStatus }} | {{ $details['order']->paymentResultOrderId }} | {{ $details['order']->paymentResultPaymentId }} | {{ $details['order']->paymentResultRazorpaySignature }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Created At</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->created_at }}</td>
                    </tr>
                    <tr class="bg-gray-200 text-gray-600 text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Updated At</th>
                        <td class="py-3 px-6 text-left">{{ $details['order']->updated_at }}</td>
                    </tr>
                </table>
                <table class="min-w-full bg-white rounded-lg shadow-md mx-auto mt-5">
                    <thead>
                    ...
                    <tbody>
                        @foreach ($details['order']->order_details as $order_detail)
                            <tr>
